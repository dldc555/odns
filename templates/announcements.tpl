...
<link rel="stylesheet" id="css-main" href="../style/css/oneui.css">
...
<link rel="stylesheet" href="{$templatedir}/style1/css/main.css">
        ...
        <![endif]-->
        <script src="style/js/scripts.min-40cb1e.js"></script>
                    ...
                    <section id="main-body">
                        <div class="main-content">
                            <section class="content-full content-boxed container">
                                <div class="bg-white push-50-t" style="border-radius: 5px;padding: 20px 25px 50px 25px;box-shadow: 1px 1px 22px rgba(157, 184, 209, 0.19);margin-bottom: 150px;">{foreach from=$news item=new}
                                    <div class="alert alert-info text-center">	<a href="{$ROOT}/index/announcement/{$new['公告ID']}/">【{$new['公告时间']}】-{$new['公告标题']}</a>
                                    </div>{/foreach}</div>
                            </section>
                        </div>
                    </section>
