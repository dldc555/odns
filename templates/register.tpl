...
<html lang="en">
	<head>
		...
		<link href="http://www.qiya521.com/templates/KiKiCloud/guojia/all.min.css" rel="stylesheet">
...
<![endif]-->
		...
		<link rel="stylesheet" type="text/css" href="{$templatedir}/style/css/fontawesome-all.min.css">
             <script src="//wxqyn.com/gt.js"></script>
		{$plug['HEAD区域']}
	</head>
					...
					<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
						<div class="push-30-t push-50 animated fadeIn">
							<div class="text-center">
                                <img src="{$tempsz['登录注册logo']}" widht="122" height="44" /> 
							</div>
<br/>	
...
<br/>
<p id="nr"><b>温馨提示：注册时请填写您的真实邮件地址，否则注册成功后无法发送"验证激活"邮件到您的邮箱，导致登录失败。</b></p>
							...
							<input name="address" type="hidden" id="address" value="中国"  />
										...
										<div id="containerNewUserSignup">
											<div class="form-group">
												<div class="col-xs-6">
													<div class="form-material form-material-success floating">
														...
														<input id="username" placeholder="用户名" name="username" type="text" class="form-control"  required="" value=""/>
												...
												<div class="col-xs-6">
													<div class="form-material form-material-success floating">
														...
														<input name="name" placeholder="姓名" type="text" id="name"  class="field form-control" value="" required=""/>
											...
											<div class="form-group">
												<div class="col-xs-12">
													<div class="form-material form-material-success floating">
														<input name="zip" placeholder="腾讯QQ" type="text" id="zip" class="form-control" value=""/>
											...
											<div class="form-group">
												<div class="col-xs-12">
													<div class="form-material form-material-success floating">
														<input name="email" placeholder="邮件地址" type="text" id="email" class="form-control" value=""/>
											...
											<div class="form-group">
												<div class="col-xs-12">
													<div class="form-material form-material-success floating">
														<input name="phone" placeholder="手机号" type="text" id="phone" class="form-control" value="" />
													...
													<div class="form-group">
														<div class="col-xs-12">
															<div class="form-material form-material-primary floating">
																 ...
																 <input id="inputNewPassword1" placeholder="密码" name="password" type="password" data-error-threshold="50"
													...
													<div class="form-group">
														<div class="col-xs-12" style="margin-bottom: -15px;">
															<div class="form-material form-material-primary floating">
																...
																<input id="inputNewPassword2" placeholder="确认密码" name="repassword" type="password" class="form-control" autocomplete="off" />
											...
											<div class="form-group">
												...
												<div class="col-xs-5 col-sm-4">
													<div class="font-s13 text-right push-5-t">
														<a href="https://www.odns.top/index.php/index/announcement/1/" target="_blank" style="color: #00AAFF;">服务条款</a>
													</div>
												</div>
											</div>
											<div class="form-group">
